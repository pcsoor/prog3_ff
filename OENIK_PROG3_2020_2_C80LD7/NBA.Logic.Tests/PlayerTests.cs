...
namespace NBA.Logic.Tests
{
    ...
    public class PlayerTests
    {
        ...
        public void Setup()
        {
            ...
            this.players.Add(new Player() { PlayerID = 1, Name = "Lebron James", Birth = new DateTime(1984, 12, 20), Height = 206, Weight = 113, Number = 23, Post = Data.Model.Player.PositionType.PowerForward, Salary = 37436858, TeamID = this.teams[9].TeamID, Team = this.teams[9] });
            this.players.Add(new Player() { PlayerID = 2, Name = "Kevin Durant", Birth = new DateTime(1988, 09, 29), Height = 208, Weight = 109, Number = 35, Post = Data.Model.Player.PositionType.PowerForward, Salary = 37199000, TeamID = this.teams[14].TeamID, Team = this.teams[14] });
            this.players.Add(new Player() { PlayerID = 3, Name = "Traeee Young", Birth = new DateTime(1998, 09, 19), Height = 185, Weight = 82, Number = 11, Post = Data.Model.Player.PositionType.PowerForward, Salary = 6273000, TeamID = this.teams[11].TeamID, Team = this.teams[11] });
            this.players.Add(new Player() { PlayerID = 4, Name = "Kawhi Leonard", Birth = new DateTime(1991, 06, 29), Height = 201, Weight = 102, Number = 2, Post = Data.Model.Player.PositionType.PowerForward, Salary = 32742000, TeamID = this.teams[8].TeamID, Team = this.teams[8] });
            this.players.Add(new Player() { PlayerID = 5, Name = "James Harden", Birth = new DateTime(1989, 08, 26), Height = 196, Weight = 100, Number = 13, Post = Data.Model.Player.PositionType.PowerForward, Salary = 38199000, TeamID = this.teams[10].TeamID, Team = this.teams[10] });
            this.players.Add(new Player() { PlayerID = 6, Name = "Zion Williamson", Birth = new DateTime(2000, 07, 06), Height = 198, Weight = 129, Number = 1, Post = Data.Model.Player.PositionType.PowerForward, Salary = 9757440, TeamID = this.teams[11].TeamID, Team = this.teams[11] });
            this.players.Add(new Player() { PlayerID = 7, Name = "Khris Middleton", Birth = new DateTime(1984, 12, 20), Height = 206, Weight = 113, Number = 23, Post = Data.Model.Player.PositionType.PowerForward, Salary = 30603448, TeamID = this.teams[21].TeamID, Team = this.teams[21] });
            this.players.Add(new Player() { PlayerID = 8, Name = "Ben Simmons", Birth = new DateTime(1991, 08, 12), Height = 201, Weight = 101, Number = 22, Post = Data.Model.Player.PositionType.PowerForward, Salary = 8113929, TeamID = this.teams[13].TeamID, Team = this.teams[13] });
            this.players.Add(new Player() { PlayerID = 9, Name = "Russell Westbrook", Birth = new DateTime(1988, 11, 12), Height = 191, Weight = 91, Number = 0, Post = Data.Model.Player.PositionType.PowerForward, Salary = 38506482, TeamID = this.teams[10].TeamID, Team = this.teams[10] });
            this.players.Add(new Player() { PlayerID = 10, Name = "Paul George", Birth = new DateTime(1990, 05, 2), Height = 203, Weight = 100, Number = 13, Post = Data.Model.Player.PositionType.PowerForward, Salary = 33005556, TeamID = this.teams[12].TeamID, Team = this.teams[12] });
            this.players.Add(new Player() { PlayerID = 11, Name = "Jayson Tatum", Birth = new DateTime(1998, 03, 3), Height = 203, Weight = 95, Number = 0, Post = Data.Model.Player.PositionType.PowerForward, Salary = 7830000, TeamID = this.teams[0].TeamID, Team = this.teams[0] });
            this.players.Add(new Player() { PlayerID = 12, Name = "Jimmy Buttler", Birth = new DateTime(1989, 09, 14), Height = 201, Weight = 104, Number = 22, Post = Data.Model.Player.PositionType.PowerForward, Salary = 32742000, TeamID = this.teams[5].TeamID, Team = this.teams[5] });
            this.players.Add(new Player() { PlayerID = 13, Name = "Damian Lillard", Birth = new DateTime(1990, 07, 15), Height = 188, Weight = 88, Number = 0, Post = Data.Model.Player.PositionType.PowerForward, Salary = 29802321, TeamID = this.teams[6].TeamID, Team = this.teams[6] });
            this.players.Add(new Player() { PlayerID = 14, Name = "Luka Doncic", Birth = new DateTime(1999, 02, 28), Height = 201, Weight = 104, Number = 77, Post = Data.Model.Player.PositionType.PowerForward, Salary = 7683360, TeamID = this.teams[17].TeamID, Team = this.teams[17] });
            this.players.Add(new Player() { PlayerID = 15, Name = "Nikola Jokic", Birth = new DateTime(1995, 02, 19), Height = 213, Weight = 129, Number = 15, Post = Data.Model.Player.PositionType.PowerForward, Salary = 27504630, TeamID = this.teams[7].TeamID, Team = this.teams[7] });
            this.players.Add(new Player() { PlayerID = 16, Name = "Robert Covington", Birth = new DateTime(1990, 12, 4), Height = 201, Weight = 95, Number = 23, Post = Data.Model.Player.PositionType.PowerForward, Salary = 27504630, TeamID = this.teams[10].TeamID, Team = this.teams[10] });

            this.testplayer = new Player { PlayerID = 33, Name = "Test Player", Birth = new DateTime(1990, 12, 4), Height = 201, Weight = 95, Number = 23, Post = Data.Model.Player.PositionType.PowerForward, Salary = 9000009 };
        }
        ...
        public void TestGetPlayerByTeam()
        {
            ...
            {
                new Player() { PlayerID = 5, Name = "James Harden", Birth = new DateTime(1989, 08, 26), Height = 196, Weight = 100, Number = 13, Post = Data.Model.Player.PositionType.PowerForward, Salary = 38199000, TeamID = this.teams[10].TeamID, Team = this.teams[10] },
                new Player() { PlayerID = 9, Name = "Russell Westbrook", Birth = new DateTime(1988, 11, 12), Height = 191, Weight = 91, Number = 0, Post = Data.Model.Player.PositionType.PowerForward, Salary = 38506482, TeamID = this.teams[10].TeamID, Team = this.teams[10] },
                new Player() { PlayerID = 16, Name = "Robert Covington", Birth = new DateTime(1990, 12, 4), Height = 201, Weight = 95, Number = 23, Post = Data.Model.Player.PositionType.PowerForward, Salary = 27504630, TeamID = this.teams[10].TeamID, Team = this.teams[10] },
            };
